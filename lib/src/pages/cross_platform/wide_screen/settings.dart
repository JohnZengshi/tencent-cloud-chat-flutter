...
import 'package:tencent_cloud_chat_flutter/utils/request.dart';
            ...
            Row(
              children: [
                SizedBox(
                  width: 40,
                  height: 40,
                  child: Avatar(faceUrl: safeFaceUrl, showName: ""),
                ),
            ...
            Row(
              children: [
                ...
                OutlinedButton(
                    onPressed: () {
                      launchUrl(
                        Uri.parse("https://github.com/TencentCloud/tencent-cloud-chat-flutter-demo"),
                        mode: LaunchMode.externalApplication,
                      );
                    },
